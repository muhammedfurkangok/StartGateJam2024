...
public class Portal : MonoBehaviour {
    ...
    void CreateViewTexture () {
        if (viewTexture == null || viewTexture.width != Screen.width || viewTexture.height != Screen.height) {
            if (viewTexture != null) {
                Debug.Log("Releasing existing RenderTexture");
                viewTexture.Release();
            }
            Debug.Log($"Creating new RenderTexture with dimensions: {Screen.width}x{Screen.height}");
            ...
            Debug.Log("RenderTexture successfully created and assigned");
        }
    }
